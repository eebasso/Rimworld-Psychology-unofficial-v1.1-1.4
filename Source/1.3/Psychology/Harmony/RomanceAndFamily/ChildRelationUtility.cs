    ...
    public static class ChildRelationUtility_ChanceOfBecomingChildOf_Patch
    {
        ...
        public static void KinseyFactor(ref float __result, Pawn father, Pawn mother, Pawn child)
        {
            if (PsychologyBase.ActivateKinsey())
            {
                ...
                {
                    if (father.GetComp<CompPsychology>() != null && father.GetComp<CompPsychology>().isPsychologyPawn)
                    {
                ...
                {
                    if (mother.GetComp<CompPsychology>() != null && mother.GetComp<CompPsychology>().isPsychologyPawn)
                    {
