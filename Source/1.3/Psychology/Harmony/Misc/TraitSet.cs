...
public class TraitSet_ManualPatches
{
    ...
    public static void HasTrait_KinseyEnabledPostfix(TraitDef tDef, Pawn ___pawn, ref bool __result)
    {
        ...
        {
            Log.Error("HasTrait_KinseyEnabledPostfix was used for TraitDefOf.Asexual");
            //num = 1;
        }
        else if (tDef == TraitDefOf.Bisexual)
        {
            Log.Error("HasTrait_KinseyEnabledPostfix was used for TraitDefOf.Bisexual");
            //num = 2;
        }
        else if (tDef == TraitDefOf.Gay)
        {
            Log.Error("HasTrait_KinseyEnabledPostfix was used for TraitDefOf.Gay");
            //num = 3;
        }
        //else
        //{
