...
//    {
//        public static string label = TraitDefOf.DrugDesire.DataAtDegree(2).label;
//        public Recipe_TreatChemicalFascination() : base(TraitDefOf.DrugDesire, HediffDefOfPsychology.DrugFree, label, 1f, TaleDefOfPsychology.TreatedDrugDesire, 2) { }
