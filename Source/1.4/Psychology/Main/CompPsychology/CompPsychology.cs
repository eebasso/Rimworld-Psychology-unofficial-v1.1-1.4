...
public class CompPsychology : ThingComp
{
  ...
  {
    get => this.beenBuried;
    set => this.beenBuried = value;
  }

  public int LDRTick
  {
    get => tickSinceLastSeenLover;
    set => tickSinceLastSeenLover = value;
  }

  public bool IsPsychologyPawn => this.Psyche != null && this.Sexuality != null;

  public override void PostExposeData()
  {
    base.PostExposeData();
    Scribe_Deep.Look(ref this.sexuality, "sexuality", new object[] { this.parent as Pawn });
