...
public static class Pawn_CheckForDisturbedSleepPatch
{
  [HarmonyPrefix]
  public static bool CheckForDisturbedSleepPrefix(Pawn __instance, Pawn source) => __instance?.story?.traits?.HasTrait(TraitDefOfPsychology.HeavySleeper) != true;
}